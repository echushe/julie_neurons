...
/******************************************************************************
 * "Abs" is a function which does forward-propagation and back-propagation of
...
private:
    ...
    // The raw activation function of Abs
    std::unique_ptr<la::Abs<float>> m_abs;
