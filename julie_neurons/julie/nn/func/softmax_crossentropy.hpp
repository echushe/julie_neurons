...
/******************************************************************************
 * "SoftMax_CrossEntropy" is a function which does forward-propagation and
 * back-propagation of the following operation:
 * 
 *      CrossEntropy ( SoftMax (tensor_a), tensor_b )
 * 
 ******************************************************************************/
...
public:
    ...
    //             SoftMax_CrossEntropy function accepts 2 inputs.
    // Returns: void
...
private:
    ...
    // The raw loss function of SoftMax_CrossEntropy
    std::unique_ptr<la::SoftMax_CrossEntropy<float>> m_sc;
