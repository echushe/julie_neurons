...
/******************************************************************************
 * "Sum" is a function which does forward-propagation and back-propagation of
 * the following operation:
 * 
 *     Sum ( tensor_a ) to get summation of all elements in a tensor
 * 
 * input: A tensor type variable
 * output: A scalar type variable
 * 
 ******************************************************************************/
class Sum : public op::Function
{
public:
...
private:
    ...
    // The raw activation function of Sum
    //std::unique_ptr<la::Sum<float>> m_relu;
