...
/******************************************************************************
 * "MatMul" is a function which does forward-propagation and back-propagation of
 * the following operation:
 * 
 *     Matrix multiplication (not element mise) of tensor_a and tensor_b
 * 
 ******************************************************************************/
...
public:
    ...
    //             MatMul function accepts 2 inputs.
    // Returns: void
...
private:
    ...
    julie::la::iMatrix<float> m_left_transpose_cache;
    julie::la::iMatrix<float> m_left_grad_cache;

    julie::la::iMatrix<float> m_right_transpose_cache;
