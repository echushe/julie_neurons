...
/********************************************************************************
 * The Conv2dCuDNN class implements forward-propagation and back-propagation of
 * 2-dimensional convolution calculations.
 * 
 * This Conv2dCuDNN class depends on NVIDIA cuDNN library
 ********************************************************************************/
...
public:
    ...
    Conv2dCuDNN (lint pad_h, lint pad_w, lint stride_h, lint stride_w);
...
private:
    ...
    static void *CUDNN_WORKSPACE;

    // descriptors for convolution forward
    cudnnTensorDescriptor_t input_descriptor;
    cudnnFilterDescriptor_t kernel_descriptor;
    cudnnTensorDescriptor_t output_descriptor;
    cudnnConvolutionDescriptor_t convolution_descriptor;
    cudnnConvolutionFwdAlgoPerf_t convolution_fwd_algorithm;

    // descriptors for convolution backward
    cudnnTensorDescriptor_t input_gradient_descriptor;
    cudnnTensorDescriptor_t output_gradient_descriptor;
    cudnnFilterDescriptor_t kernel_gradient_descriptor;
    cudnnConvolutionBwdFilterAlgoPerf_t convolution_bwd_kernel_algorithm;
    cudnnConvolutionBwdDataAlgoPerf_t convolution_bwd_data_algorithm;
