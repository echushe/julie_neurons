...
/*********************************************************************************
 * Here are some common calculations of matrices via the iMatrix interface
 *********************************************************************************/
...
// This method is to get a mast matrix where element value is ZERO if the corresponding element
...
// This method is to get a mast matrix where element value is ZERO if the corresponding element's
...
template <typename DT>
void concatenate(iMatrix<DT> &output, const iMatrix<DT> &mat1, const iMatrix<DT> &mat2, lint dim);
