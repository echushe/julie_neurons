...
/*********************************************************************************
 * Here are some advanced calculations of matrices via the Matrix_CUDA interface
 *********************************************************************************/
...
// Returns: void
template <typename DT>
void pad_2d_backward(Matrix_CUDA<DT> & output, const Matrix_CUDA<DT> & gradient, lint pad_h, lint pad_w);
...
// Returns: void
template <typename DT>
void img2col_2d(Matrix_CUDA<DT> & output, const Matrix_CUDA<DT> & input, lint stride_h, lint stride_w, lint w_h, lint w_w);
