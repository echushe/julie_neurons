...
This is a convolutional neural network (GoogleNet) example applying ***Conv2d***, ***PReLU***, ***MaxPool***, ***concat*** and ***SoftMax*** operations.
...
```
./googlenet <Path_of_the_MNIST_dataset>
```

For example:

```
./googlenet ../../../dataset/mnist/
```
